<?php include "template/Header.php"; ?>
    ...
    <div class="jumbotron" style="margin-left: 200px; margin-right: 200px; margin-top: 15px">
        ...
        <form method="post" action="reg_action.php" style="margin-left: 70px; margin-right: 70px">
            ...
            <input type="submit" name="register" value="ثبت نام" class="btn btn-block btn-outline-success btn-block badge-pill" style="font-size: 16px">
        </form>
